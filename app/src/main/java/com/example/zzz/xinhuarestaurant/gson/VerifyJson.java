...
/**
 * Created by zzz on 2017/11/16.
 */

public class VerifyJson {
    /**
     * request_status : successful
     * return_info : {"status_code":2024,"request_message":"短信验证码正确","request_time":1510792503,"request_proof":true,"token":null}
     */
    ...
    public static class ReturnInfoBean {
        /**
         * status_code : 2024
         * request_message : 短信验证码正确
         * request_time : 1510792503
         * request_proof : true
         * token : null
         */
